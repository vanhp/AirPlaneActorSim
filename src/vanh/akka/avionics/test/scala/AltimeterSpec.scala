...
//import vanh.akka.avionics.EventSource
...
//  def wordSpec: BeforeAndAfterAll =  BeforeAndAfterAll()
...
//  import Altimeter._
//  import vanh.akka.avionics.EventSource._
//
...
//    // directly.
//    def actor() = {val a = TestActorRef[Altimeter](Props(slicedAltimeter))
//      (a, a.underlyingActor)
//    }
//  }
//  "Altimeter" should {
